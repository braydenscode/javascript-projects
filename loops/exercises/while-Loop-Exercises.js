...
//b. Use a second loop to query the user for the number of astronauts (up to a maximum of 7). Validate the entry.
  while (astronautsAboard <= 0 || astronautsAboard >= 8 || isNaN(astronautsAboard)) {
...
while (fuelLevel >= astronautsAboard * 100) {
fuelLevel -= (astronautsAboard * 100);
shuttleAltitude += 50;
 console.log(`Remaning Fuel: ${fuelLevel}`);
...
If the altitude is 2000 km or higher, add “Orbit achieved!” Otherwise add, “Failed to reach orbit.”*/
  ...
  else if (fuelLevel < astronautsAboard * 100) {
